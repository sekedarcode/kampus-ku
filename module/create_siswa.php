<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($check_ifexist)) {
            ...
            $query_tambahsiswa = "INSERT INTO `tbl_siswa` (`nis`, `nama_siswa`, `jenis_kelamin`, `alamat`, `no_telp`, `email`, `tgl_terdaftar`) VALUES ('$nis', '$nama_siswa', '$jenis_kelamin', '$alamat', '$no_telp', '$email', current_timestamp())";
